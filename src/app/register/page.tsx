...
import { Mail, Lock, User, MapPin, UserPlus, AlertCircle, Eye, EyeOff, CheckCircle } from "lucide-react";
        ...
        <div className="glass-card p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-brand-card px-3 text-blue-200/40">o registrarte con email</span>
            </div>
          </div>
